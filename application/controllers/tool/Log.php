...
class Log extends Admin_Api_Controller {
    ...
    public function report(){
        ...
        //总充值额
        $pay_parm_in['time >'] = strtotime($startdate);
        $pay_parm_in['time <'] = strtotime($enddate);
        $order_parm_in['createtime >'] = strtotime($startdate);
        $order_parm_in['createtime <'] = strtotime($enddate);
